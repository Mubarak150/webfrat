...
export default function ServicesContainer() {
    ...
    return (
        <div className="block mt-20 md:mt-0" >
            <div id='services' className="flex  flex-col justify-center align-center h-auto lg:h-screen w-full font-poppins md:p-28 box-border  md:py-32 pb-0  xl:px-36 md:mt-0">
                {/* returning heading and sub-heading */}
                <HeadAndSub head='Provided Features' sub='Our Services' />

                {/* RETURNING ALL THE AVAILABLE FEATURES.... */}
                <div className="flex flex-col  md:grid md:grid-cols-2 lg:flex lg:flex-row justify-center items-stretch gap-3 m-4 md:m-0 p-4 md:p-0 md:gap-4 mt-8 md:mt-20">
