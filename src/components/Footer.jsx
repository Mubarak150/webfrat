...
export default function Footer () {
    return (
        ...
        <div className="bg-slate h-auto w-[99.99%] flex flex-col md:flex-row gap-4 md:gap-12 md:items-start justify-between mt-16 px-4 md:px-32 py-12 text-white  text-md ">
            <div className="font-thin flex flex-col gap-1 md:gap-4">
            ...
            <div className='flex flex-col gap-1 md:gap-3 m-0 p-0 md:m-0 md:p-0'>
            ...
            <div className='flex flex-col gap-y-4'>
                ...
                <form action="" className='flex flex-col gap-2'>
                    ...
                    <button type='submit' className='text-white font-medium bg-blue rounded-3xl md:px-24 py-2  hover:text-white hover:bg-slate hover:border hover:border-white  transition-colors duration-300 ease-in-out'>Submit</button>
                </form>
            </div>
            
            </div>
            <div className="bg-slate flex justify-center flex-col md:items-center">
                <div className="w-[87%] h-[1px] bg-white justify-self-start "></div>
                    <div className="flex flex-col md:flex-row gap-4 md:gap-12 bg-slate text-white p-4 md:px-32 pt-8 pb-12 md:self-start">
                        <p className="">© 2024 Glucie</p>
